  ...
  wayland.windowManager.hyprland = {
    settings = {
      ...
      workspace = [
        ...
        # "name:dpp, monitor:DP-1, default:true" # DisplayPort, HUB, eGPU…
        "name:dpp, monitor:DP-4, default:true" # DisplayPort, HUB, eGPU…
        # "name:dpp, monitor:DP-5, default:true" # DisplayPort, HUB, eGPU…
        # "name:dpp, monitor:DP-6, default:true" # DisplayPort, HUB, eGPU…
        # "name:dpp, monitor:DP-7, default:true" # DisplayPort, HUB, eGPU…
        # "name:dpp, monitor:DP-8, default:true" # DisplayPort, HUB, eGPU…
        # "name:hdm, monitor:DP-2, default:true" # External, Videoprojector
        "name:hdm, monitor:DP-3, default:true" # External, Videoprojector
      ];
      env = [
